...
scoreboard players operation @s bc.cv_numB_1 = @s bc.cv_num_1
scoreboard players operation @s bc.cv_numB_1 /= #1B bc.const
...
scoreboard players operation @s bc.cv_numB_2 = @s bc.cv_num_2
scoreboard players operation @s bc.cv_numB_2 /= #1B bc.const
